            ...
            <div className={style.advantage}>
                ...
                <div>
                    ...
                    <h6 className={style.advantageTextSecond}>Мы не говорим, что качество проектов, выполненных на
                        аутсорсе хуже - оно действительно может быть неплохим. Но будучи полностью посвященными одному
                ...
                <div>
                    ...
                    <h6 className={style.advantageTextSecond}>Создание команды в другой стране - непростая задача, если
                        нет финансовых стимулов. К счастью, аутстаффинг имеет тенденцию сокращать расходы, а также
                        справляется с задачей сохранения качества. Сложив эти два фактора, вы получите беспроигрышный
                        вариант.</h6>
                </div>
                <div>
                    <h3 className={style.advantageTextBlock}>Гибкость команды</h3>
                    <h6 className={style.advantageTextSecond}>Мы хотим, чтобы проекты росли и процветали. Масштабировать
                        бизнес или сбавить обороты- в любом случае, аутстаффинг дает вам большую гибкость при изменении
                ...
                <div>
                    ...
                    <h6 className={style.advantageTextSecond}>Аутстаффинг сохраняет преимущества классического
                        ...
                        рекрутеру быть полностью вовлеченными в процесс найма, что позволит выбрать наиболее подходящих
                        кандидатов.</h6>
                </div>
            </div>
            <Resources/>
